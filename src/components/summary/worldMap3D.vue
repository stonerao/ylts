<template>
    <div class="wrapper">
        <div ref="world-map-3d" id="main"></div>
...
import pic1 from './pics/stars.jpg';
import pic3 from './pics/heighttext.jpg';
...
export default {
    ...
    mounted(){
        this.worldMapContainer = this.$refs['world-map-3d']
        // 设置容器高宽
        ...
        mapHeightChart.setOption(this.heightOption);
        ...
        axios.all([axios.get('/data/locations'), axios.get('/data/alarms')]).then((response) => {
            ...
            this.option.series[0].data = linesData;
            this.myChart.setOption(this.option);
